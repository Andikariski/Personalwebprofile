                            ...
                            <tbody>
                                ...
                                <?php foreach ($project as $p) : ?>
                                    <tr>
                                        ...
                                        <td> <img src=" <?= base_url('assets/') ?>img/<?= $p['img'] ?> " width="150px" height="90px"></td>
                                        <td class="ml-3">
                                            <a href="<?= base_url() ?>admin/hapusDataUser/<?= $p['id'] ?>" class="badge badge-danger tombol-hapus"><i class="fa fa-trash"> </i> Hapus</a>
                                            <a href="<?= base_url() ?>admin/UbahDataAkun<?= $p['id'] ?>" class="badge badge-success" data-toggle="modal" data-target="#Editakun<?= $p['id'] ?>"><i class=" fa fa-edit"></i> Edit</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
